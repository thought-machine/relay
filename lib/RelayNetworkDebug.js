...
var RelayNetworkDebugger = function () {
  function RelayNetworkDebugger() {
    ...
    this._queryID = 0;
    this._subscription = require('./RelayPublic').Store.addNetworkSubscriber(function (request) {
  ...
  RelayNetworkDebugger.prototype.logRequest = function logRequest(_ref) {
    ...
    var onSettled = function (error, response) {
...
function createDebuggableFromRequest(type, request) {
  return {
    ...
    logResult: function (error, response) {
      /* eslint-disable no-console */
