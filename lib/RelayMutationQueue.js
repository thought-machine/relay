...
function getTracker(storeData) {
  ...
  require('fbjs/lib/invariant')(tracker, 'RelayMutationQueue: a RelayQueryTracker instance must be configured. ' + 'Use `RelayStoreData.injectQueryTracker()` in order to process ' + 'RelayMutation instances.');
  return tracker;
}
